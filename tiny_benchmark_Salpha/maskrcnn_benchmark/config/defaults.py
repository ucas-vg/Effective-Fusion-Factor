...
_C.MODEL.FPN.FUSION_FACTORS = [1,1,1]   # Alpha45,Alpha34,Alpha23 (has been counted)
_C.MODEL.FPN.STATISTICS_ALPHA_ON = False # Control whether start the statistical process of Alpha
_C.MODEL.FPN.STATISTICS_ALPHA_ITER = -1  # one epoch of statistical process of Alpha, -1 means Skipping the process
