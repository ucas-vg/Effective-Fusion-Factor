...
from maskrcnn_benchmark.modeling.statistics_alpha.sta_alpha import StaAlphaModule
...
if __name__ == "__main__":
    print("tinybenchmark-Salpha ")
    import datetime
    sta = datetime.datetime.now()
    main()
    end = datetime.datetime.now()
    print("tinybenchmark-Salpha all time:",(end - sta))
